 ...
 * 
 * O Governador do Estado quer saber sobre as taxas de crescimento das cidades. De acordo com dados da população e 
 * a taxa de crescimento de duas cidades quaisquer (A e B), ele quer que você calcule quantos anos levará para que
 * a cidade menor (A) cresça mais em população que a cidade maior (B).
 * 
 * Claro que o Governador quer saber apenas para as cidades cuja taxa de crescimento da cidade A é maior do que a
 * taxa de crescimento da cidade B, portanto, previamente já separou para você apenas os casos de teste que tem a 
 ...
 * para estes casos, já que ele pode não estar mais eleito. Basta que você informe, nesta situação, a mensagem
 * "Mais de 1 século.".
 * 
 * Entrada
